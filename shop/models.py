...
class Product(models.Model):
    ...
    tags = models.ManyToManyField(
        Tag, related_name="products", blank=True, verbose_name="تگ‌ها"
    )
...
class ProductVariation(models.Model):
    ...
    sku = models.CharField(
        max_length=255, unique=True, verbose_name="شناسه محصول (SKU)"
    )
    wood_type = models.CharField(
        max_length=255, default="Walnut", verbose_name="نوع چوب"
    )
    ...
    preparation_days = models.PositiveIntegerField(
        default=0, verbose_name="روزهای آماده سازی"
    )
...
class ProductImage(models.Model):
    product = models.ForeignKey(
        Product, related_name="images", on_delete=models.CASCADE, verbose_name="محصول"
    )
...
class Review(models.Model):
    product = models.ForeignKey(
        Product, related_name="reviews", on_delete=models.CASCADE, verbose_name="محصول"
    )
